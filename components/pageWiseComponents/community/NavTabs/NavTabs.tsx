...
const NavTabs = () => {
  ...
  return (
  <div className='w-full h-20 bg-BgBrutalSkin1 flex justify-start sm:justify-center items-center space-x-3 lg:space-x-5 px-5 py-2 md:py-4 sticky top-0 overflow-x-scroll overflow-y-hidden scrollbar-hide'>
