...
const uploadPost = () => {
  ...
  return (
    <main className='w-full lg:w-[70%] h-[80vh] lg:h-[90vh] mt-[10vh] mb-[10vh] lg:mb-0 bg-white flex flex-col justify-center items-center'>
      ...
      {/*  Large Screen  */}  
      <div className='hidden lg:inline w-[80%] bg-white border-2 border-BrutalBlack1' >
            ...
            <div className='w-full h-full flex flex-col justify-start items-center space-y-2 bg-lightColor'>
              <div className='w-[90%] h-10 relative bg-black flex justify-start items-center border border-black'>
                <input
                  ...
                  type="text"
                  placeholder='Title'
                  className='w-full h-10 absolute right-[2px] bottom-[2px] outline-none focus:ring-0 px-2 placeholder:px-2 border border-black font-medium'
                />
              </div>
              ...
              <div className='w-[90%] h-full relative bg-black flex justify-start items-center border border-black'>
                <textarea
                  placeholder='Caption'
                  className='w-full h-full absolute right-[2px] bottom-[2px] outline-none focus:ring-0 px-2 py-2 placeholder:px-2 border border-black  font-medium'
